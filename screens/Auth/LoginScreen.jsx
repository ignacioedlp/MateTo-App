...
const LoginScreen = () => {
  ...
  const login = async () => {
    setLoading(true);
    await signInWithApi(email.toLowerCase(), password);
    setLoading(false);
  }

  return (
    <Screen>
      <View className="flex flex-col justify-around h-full pt-16">
        <View className="flex flex-col items-center justify-center">
          <View>
            <MatetoLogo />
          </View>
        </View>
        <ScrollView className="mt-20 mb-8">
          <View className="flex flex-col justify-between space-y-20">
            ...
            <View className="flex flex-col items-center justify-center mt-4 space-y-4">
              ...
              <TouchableOpacity className="w-full border-black border-2 h-[55px] items-center justify-center rounded-full flex flex-row space-x-3" onPress={() => { }}>
